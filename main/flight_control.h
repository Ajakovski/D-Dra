...
// ESC GPIO assignments
    // ============================================================
#define FC_ESC1_GPIO    35       // M1 Front-Right CW
#define FC_ESC2_GPIO    41       // M2 Front-Left  CCW
#define FC_ESC3_GPIO    4      // M3 Rear-Right  CCW
#define FC_ESC4_GPIO    39      // M4 Rear-Left   CW
